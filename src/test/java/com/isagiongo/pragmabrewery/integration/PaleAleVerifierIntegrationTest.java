...
public class PaleAleVerifierIntegrationTest {
	...
	@Test
	public void shouldValidateIfTemperatureIsLessThanMinimumForPaleAle() {
		RestAssured
				.given()
				.contentType(ContentType.JSON)
	...
	@Test
	public void shouldValidateIfTemperatureIsGreaterThanMaximumForPaleAle() {
		RestAssured
				.given()
				.contentType(ContentType.JSON)
				.body("{\"temperature\": -3}")
